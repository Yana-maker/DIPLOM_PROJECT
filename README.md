...
4. Установите необходимые зависимости, запустив pip install -r requirements.txt.
5. Настройте базу данных, создав папку базы данных с помощью models.py для определения моделей базы данных и db.py для установления подключения к базе данных.
6. Настройте подключение к базе данных в файле database.db.
7. Запустите приложение FastAPI, выполнив команду uvicorn main:app --reload.
